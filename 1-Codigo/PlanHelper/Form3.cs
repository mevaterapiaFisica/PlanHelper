...
namespace PlanHelper
{
    public partial class Form3 : Form
    {
        ...
        private void LlenarDGVPedidos()
        {
            ...
            {
                DataGridViewRow fila = new DataGridViewRow();
                fila.CreateCells(DGV_Pedidos);
                fila.Cells[0].Value = ped.Paciente;
                fila.Cells[1].Value = ped.Tecnica;
                fila.Cells[2].Value = ped.Tarea;
                fila.Cells[3].Value = ped.Equipo;
                fila.Cells[4].Value = ped.FechaLimite.ToString("dd/MM/yyyy", CultureInfo.InvariantCulture);
                fila.Cells[5].Value = ped.MedicoResponsable;
                fila.Cells[6].Value = ped.Motivo;
                fila.Cells[7].Value = ped.Solicita;
                fila.Cells[8].Value = ped.Responsable;
                fila.Cells[9].Value = ped.Comentario;
                DGV_Pedidos.Rows.Add(fila);
        ...
        private void BT_EditarPedido_Click(object sender, EventArgs e)
        {
        ...
        private void BT_EliminarPedido_Click(object sender, EventArgs e)
        {
            if (pedidoSeleccionado() != null)
            {
                var pedidos = Pedido.LeerArchivo();
        ...
        private void BT_CompletarPedido_Click(object sender, EventArgs e)
        {
            if (pedidoSeleccionado() != null)
            {
                var pedidos = Pedido.LeerArchivo();
